module Socket = {
  ...
  [@bs.send] external onEvent: (t, string, Js.Json.t => unit) => unit = "on";
  ...
  [@bs.send] external emit: (t, string, string) => unit = "emit";
};

module Client = {
  [@bs.module "socket.io-client"] [@bs.new]
  external create: unit => Socket.t = "default";
  [@bs.module "socket.io-client"] [@bs.new]
  external createWithUrl: string => Socket.t = "default";
};
